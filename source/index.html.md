...
| `linkedAccount`                 | Optionally pass the `_id` of a [LinkedAccount](#linkedaccount-object). When used, Transact will immediately begin authenticating upon opening. This parameter is used when the [LinkedAccount](#linkedaccount-object)'s `mfaRequired` list include the desired product.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `mfaRequired` | array | Array of products for which the user will be required to be present and authenticate within [Transact](#transact-sdk). |
